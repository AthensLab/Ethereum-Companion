...
## “Ethereum” Basics
- Ethereum "pre-history" (Vitalik Buterin blog post) [Interesting to read as Buterin goes through the internal thought process of creating a fee based ledger that is Turing complete, i.e a state machine. Note the simplicity of the programmatic loop the devises to validate his concept]
